...
const CACHE = "salud-121721ce";
const PREFIJO = "salud-";
const ARCHIVOS = ["./","./index.html","./app.js","./manifest.json","../config.js","./icon-192.png","./icon-512.png","./icon-maskable-512.png","./apple-touch-icon.png","./favicon-32.png"];
const EXCLUIR = [];
